...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		monthNames: ["Janvier","Février","Mars","Avril","Mai","Juin",
			"Juillet","Aoüt","Septembre","Octobre","Novembre","Décembre"], // Names of months for drop-down and formatting
		monthNamesShort: ["Jan", "Fév", "Mar", "Avr", "Mai", "Jun", "Jul", "Aoû", "Sep", "Oct", "Nov", "Dec"], // For formatting
	...
	this.regional[ "Fr" ] = $.extend( true, {}, this.regional.en );
...
/**
 * Fonction qui vérifie si on est en début ou fin de mois
 * et retourne le mois suivant la condition et
 * en format lettres.
 * @returns mois qui est un mois en lettre. De type chaîne.
 */
function getMois() {

    var d = new Date(); //Date du jours
    var m = d.getMonth() + 1; //Le mois en cours. + 1 car le tableau commence à 0.
    var j = d.getDate(); //Le jour en cours
    var mois;// Variable qui contiendra le mois en lettres.
    var annee = d.getFullYear();//L'année en cours
    var laDate;
    
    //mettre le mois précédent si la date est avant ou égal au 10 du mois sinon
    //Mettre sur le courant du mois
    if(j <= 10){
        if(m === 1){
            m = 12;
            annee--;
