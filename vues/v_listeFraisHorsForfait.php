...
<table class="table">
    ...
    foreach ($lesFraisHorsForfait as $unFraisHorsForfait) {
        ...
        <tr>
            ...
            <td><a class="btnSupprimer" href="index.php?uc=gererFrais&action=supprimerFrais&idFrais=<?php echo $id ?>" 
    ...
    <form action="index.php?uc=gererFrais&action=validerCreationFrais" method="post">
        <div id="divFichF">
            <div class="corpsForm">
                ...
                <fieldset>
                    <legend class="legendeHF">Frais hors forfait</legend>
                    <p>
                    <div id="idDateMois">
                        <p> 
                            <label id="idTxtDateHF" for="txtDateHF">Date (jj/mm/aaaa):</label>
                            <input type="text" id="txtDateHF" name="dateFrais" size="50" value="Cliquez ici">
                        </p>
                    ...
                    <p>
                        ...
                        <input type="text" id="txtMontantHF" name="montant" size="50" maxlength="10" value="" />&nbsp;€
                    </p>
                </fieldset>
            </div>
            <br><br><br><br>
